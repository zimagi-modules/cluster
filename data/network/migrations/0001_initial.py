    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('environment', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='network_relation', to='environment.Environment')),
                ('groups', models.ManyToManyField(related_name='network_relation', to='group.Group')),
            ],
            options={
                'verbose_name': 'network',
                'verbose_name_plural': 'networks',
                'db_table': 'cluster_network',
                'ordering': ['cidr'],
                'abstract': False,
            },
        ),
